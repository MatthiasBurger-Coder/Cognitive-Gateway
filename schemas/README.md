...
are outside the current JSON adapter. `Registry::validate_integrity()` provides
the separate cross-definition reference and skill dependency-graph validation
step.
